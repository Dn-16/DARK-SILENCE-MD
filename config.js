...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "DARK-SILENCE-MD~WB5BmKwY#Nm50NMUn7MRtxbrYghJxhbIP6cdh2b1ExCuNPEucy9M",
    CAPTION: process.env.CAPTION || "POWERED BY DANIEL",
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "260979385883",
    OWNER_NAME: process.env.OWNER_NAME || "DANIEL",
    READ_CMD: process.env.READ_CMD || "true",
    BOT_NAME: process.env.BOT_NAME || "DANIEL",
